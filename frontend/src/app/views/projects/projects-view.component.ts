...
@Component({
  ...
  template: `
    <section class="projects section parallax-section parallax-projects" id="projects" data-parallax data-parallax-speed="0.12" data-parallax-speed2="0.24">
      <app-section-header 
        title="Projects" 
      ...
      <div class="projects-grid">
        @for (project of projects; track project.id) {
          <article class="project-card reveal-on-scroll hover-elevate" [class.featured]="project.featured">
            @if (project.featured) {
            ...
            <div class="project-content">
              ...
              @if (project.techStack) {
                <div class="chip-group">
                  @for (tech of getTechArray(project.techStack); track tech; let i = $index) {
...
export class ProjectsViewComponent {
  ...
  getChipClass(index: number): string {
    const classes = ['chip-code', 'chip-code-pink', 'chip-code-orange', 'chip-code-mango'];

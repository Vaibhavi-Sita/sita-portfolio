...
@Component({
  ...
  template: `
    ...
    <section class="certifications section parallax-section parallax-certifications" id="certifications" data-parallax data-parallax-speed="0.12" data-parallax-speed2="0.22">
      <app-section-header 
        title="Certifications" 
        subtitle="Stamps of approval, earned the hard way"
        number="07">
      </app-section-header>
      ...
      <div class="certifications-grid">
        @for (cert of certifications; track cert.id; let i = $index) {
          <div class="certification-card reveal-on-scroll hover-elevate" [class]="getCardClass(i)">
            <div class="cert-icon">
...
export class CertificationsViewComponent {
  ...
  getIcon(cert: Certification): string {
    ...
    if (name.includes('security') || name.includes('certified')) return 'verified_user';
    if (name.includes('publication') || name.includes('journal') || name.includes('research')) return 'article';
